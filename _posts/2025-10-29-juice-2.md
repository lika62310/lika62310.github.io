...
<img width="90%" alt="image" src="https://github.com/user-attachments/assets/a72f7703-77e8-4f47-afb5-e39c7debaad8" />
...
<img width="90%" alt="juicepw" src="https://github.com/user-attachments/assets/1ee7b39b-773c-4288-af2c-aacaa8b204ec" />

En afprøvning af oplysningerne viser, at de virker.

#### Kurvadgang og session keys

På kurv-siden, kan der under session storage ses værdien 'bid', som kunne ligne et id. Dette kan testesved at rette den til andet nummer gemidlæse kurven - hvor der nu kan ses indholdet af en andens kurv. Her udnyttes horizotal privilege escalation, hvor brugeren får adgang til indhold på samme adgangsniveau. 
...
<img width="90%" alt="image" src="https://github.com/user-attachments/assets/2939209c-8a31-4e4f-a58c-9ae8f6123e13" />
...
<img width="90%" alt="image" src="https://github.com/user-attachments/assets/04a46063-b37b-401c-885e-f3d6161eb0f7" />
<img width="90%" alt="image" src="https://github.com/user-attachments/assets/5eef63c6-d6f0-4acb-8639-5f59267b0516" />
...
### Feedback og bruger-id

For at løse *Forged Feedback* skal brugerfeedback (under /contact) afgives som værende fra en anden bruger, end den der er logget ind. Ved hjælp af [Burp Suite](https://portswigger.net/burp/communitydownload) kan vi (med Intercept slået til) se HTTP-andmodningen før den sendes, og ser, at brugeren identificeres med et UserId.

<img width="714" height="428" alt="image" src="https://github.com/user-attachments/assets/8177ddff-38b9-4d03-af97-965eb896b313" />

Denne ændres og anmodningen sendes videre, og eftersom applikationen ikke validerer, at UserId matcher den bruger, som er logget ind, kan feedbacken nu ses under den nye brugers historik. På lignende vis kan en brugeranmeldelse af et produkt sendes fra en anden bruger (*Forged Review*).

Rolle-atributten kan ligeledes manipuleres på denne vis når en ny bruger oprettes, og en ny bruger med admin-rettigheder kan grundet utilstrækkelig inputvalidering oprettes.

<img width="90%" alt="image" src="https://github.com/user-attachments/assets/41263776-bb75-4fa5-b3bb-975e354fb84f" />
